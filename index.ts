...
export module ReactNativeBiometricsLegacy {
  ...
  export function createKeys(
    ...
    return new ReactNativeBiometrics().createKeys(options);
  }
   ...
   */
  export function biometricKeysExist(
    options: BiometricKeysExistOptions
  ): Promise<BiometricKeysExistResult> {
    return new ReactNativeBiometrics().biometricKeysExist(options);
  }
  ...
  export function deleteKeys(
    deleteKeysOptions: DeleteKeysOptions
...
export default class ReactNativeBiometrics {
  ...
  biometricKeysExist(
    ...
    return bridge.biometricKeysExist(options);
  }
